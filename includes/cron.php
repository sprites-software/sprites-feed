...
//      add_action( 'sfs_cron_hook', array($this, 'sfs_cron_persist_feed_posts') );
//      add_action( 'sfs_cron_hook_secondary', array($this, 'sfs_cron_persist_twitter_feed_posts') );
//      add_action( 'sfs_cron_hook_events', array($this, 'sfs_cron_persist_social_events') );
//      add_action( 'sfs_cron_hook_videos', array($this, 'sfs_cron_persist_videos') );
//      add_action( 'sfs_cron_hook_albums', array($this, 'sfs_cron_persist_albums') );
//      add_action( 'sfs_cron_hook_people', array($this, 'sfs_cron_persist_people_videos') );
//    }
//
...
//    }
//
//    public function sfs_cron_persist_albums($data) {
...
//    }
//
//    public function sfs_cron_persist_videos($data) {
//      $last_import_date = $this->getLastImportDate();
...
//    }
//
//    public function sfs_cron_persist_feed_posts($data) {
//      $last_import_date = $this->getLastImportDate();
//      foreach ($data as $post) {
...
//      }
//    }
//    public function sfs_cron_persist_twitter_feed_posts($data) {
//      $last_import_date = $this->getLastImportDate();
//      foreach ($data as $post) {
//        $data = json_decode(json_encode($post), true);
...
//      }
//    }
//    public function sfs_cron_persist_social_events($data) {
//      $last_import_date = $this->getLastImportDate();
//      foreach ($data as $post) {
...
//    }
//
//    public function sfs_cron_persist($data, $type) {
//      switch($type) {
